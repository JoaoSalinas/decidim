"use strict";
(self["webpackChunkdecidim_base"] = self["webpackChunkdecidim_base"] || []).push([["vendors-node_modules_graphiql_react_dist_info_es_js"],{
...
function getTypeInfo(schema, tokenState) {
  ...
  (0,_forEachState_es_js__WEBPACK_IMPORTED_MODULE_1__.f)(tokenState, function (state) {
    var _a, _b;
    switch (state.kind) {
      case "Query":
      case "ShortQuery":
      ...
      case "Argument":
        ...
        break;
      case "EnumValue":
        var enumType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__.getNamedType)(info.inputType) : null;
        info.enumValue = enumType instanceof graphql__WEBPACK_IMPORTED_MODULE_2__.GraphQLEnumType ? find(enumType.getValues(), function (val) {
          return val.value === state.name;
        }) : null;
        break;
      case "ListValue":
        var nullableType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__.getNullableType)(info.inputType) : null;
        info.inputType = nullableType instanceof graphql__WEBPACK_IMPORTED_MODULE_2__.GraphQLList ? nullableType.ofType : null;
        break;
      case "ObjectValue":
        var objectType = info.inputType ? (0,graphql__WEBPACK_IMPORTED_MODULE_2__.getNamedType)(info.inputType) : null;
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.defineOption("info", false, function (cm, options, old) {
...
function onMouseOver(cm, e) {
  ...
  var onMouseMove = /* @__PURE__ */__name(function () {
    clearTimeout(state.hoverTimeout);
    state.hoverTimeout = setTimeout(onHover, hoverTime);
  }, "onMouseMove");
  var onMouseOut = /* @__PURE__ */__name(function () {
  ...
  var onHover = /* @__PURE__ */__name(function () {
    _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.off(document, "mousemove", onMouseMove);
    _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.off(cm.getWrapperElement(), "mouseout", onMouseOut);
    state.hoverTimeout = void 0;
    onMouseHover(cm, box);
...
function showPopup(cm, box, info) {
  ...
  var popupTimeout;
  var onMouseOverPopup = /* @__PURE__ */__name(function () {
  ...
  var hidePopup = /* @__PURE__ */__name(function () {
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("info", "graphql", function (token, options) {
  ...
  var kind = state.kind;
  var step = state.step;
  var typeInfo = (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_1__.g)(options.schema, token.state);
...
function text(into, content) {
  ...
  var ref = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  if (className) {
