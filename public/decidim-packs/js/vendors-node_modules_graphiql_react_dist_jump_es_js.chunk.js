"use strict";
(self["webpackChunkdecidim_base"] = self["webpackChunkdecidim_base"] || []).push([["vendors-node_modules_graphiql_react_dist_jump_es_js"],{
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.defineOption("jump", false, function (cm, options, old) {
...
function onKeyDown(cm, event) {
  ...
  var onKeyUp = /* @__PURE__ */__name(function (upEvent) {
  ...
  var onClick = /* @__PURE__ */__name(function (clickEvent) {
    var destination = cm.state.jump.destination;
    if (destination) {
      cm.state.jump.options.onClick(destination, clickEvent);
    }
  }, "onClick");
  var onMouseDown = /* @__PURE__ */__name(function (_, downEvent) {
...
_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("jump", "graphql", function (token, options) {
  ...
  var kind = state.kind;
  var step = state.step;
  var typeInfo = (0,_SchemaReference_es_js__WEBPACK_IMPORTED_MODULE_1__.g)(options.schema, state);
